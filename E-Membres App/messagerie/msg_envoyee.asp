...
<TABLE width="100%"  border="0" cellspacing="0" cellpadding="0">
  <TR>
    <TD width="69%"><strong>Vous &ecirc;tes ici :</strong> <a href="../auth/index.asp">Accueil</a> &gt; <a href="msg_envoyee.asp">Messages Envoyés</a></TD>
    ...
    %>
      ...
      <TABLE border="0" cellPadding="0" cellSpacing="0" width="100%">
        <TR>
          ...
          <TD class="boxtitleBG">
            <DIV class="boxtitle">Messages Envoyés</DIV>
          </TD>
        </TR>
        <TR>
	    ...
	    <FORM action="delete.asp?A=msg_envoyee" method="POST">
		  ...
		  <TABLE width="100%"  border="0" cellpadding="0" cellspacing="0">
		        ...
		        <DIV align="center"><B><% = Request.QueryString("msg") %></B></DIV>
                    ...
                    <TR bgcolor="<% =cadre_color %>">
                      ...
                      <TD width="5%" bgcolor="<% =cadre_color %>"><DIV align="center"></DIV></TD>
                      <TD width="24%" height="20"><font color="#ffffff">Á</font></TD>
                      <TD width="44%"><font color="#ffffff">Objet</font></TD>
                    ...
                    <TR>
  	                ...
  	                <%
                        SQL = "SELECT * FROM MESSAGE_ENVOYEE WHERE mDE='" & session("user") & "' ORDER BY mDate DESC"
                        SET rSC = Connect.Execute(SQL)

                        If rSC.EoF Then  ' Test si il y a des données à afficher
                          response.write "<BR><DIV align=center><B>Votre Boîte de Messages Envoyés est vide</B></DIV><BR>"
                        Else
			  ...
			  %>
				...
				<TD width="24%"><a href="index.asp?A=<% =rSC("mA")%>"><% =rSC("mA") %></a></TD>
				<TD width="44%"><a href="message.asp?A=msg_envoyee&msg_ID=<% =rSC("mID_message")%>"><% =rSC("mObjet") %></a></TD>
